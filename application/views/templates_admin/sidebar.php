  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('admin/dashboard') ?>">
        ...
        <div class="sidebar-brand-text mx-1">SISFO <sup>AKADEMIK</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('admin/prodi') ?>">Program Studi</a>
            <a class="collapse-item" href="<?php echo base_url('admin/mapel') ?>">Mata Pelajaran</a>
            ...
            <a class="collapse-item" href="<?php echo base_url('admin/krs') ?>">KRS</a>
            <a class="collapse-item" href="<?php echo base_url('admin/nilai/input_nilai') ?>">Input Nilai</a>
            <a class="collapse-item" href="<?php echo base_url('admin/nilai') ?>">KHS</a>
            <a class="collapse-item" href="<?php echo base_url('admin/transkrip_nilai')?>">Cetak Transkip</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('admin/hubungi_kami') ?>">Pesan User</a>
            <a class="collapse-item" href="<?php echo base_url('admin/informasi') ?>">Informasi Sekolah</a>
            <a class="collapse-item" href="<?php echo base_url('admin/about_us') ?>">Tentang Sekolah</a>
            <a class="collapse-item" href="<?php echo base_url('admin/fasilitas') ?>">Fasilitas</a>
