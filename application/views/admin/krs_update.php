...
<nav aria-label="breadcrumb" >
    ...
    <li><i class="fas fa-university mr-2"></i></li>
      ...
      <li class="breadcrumb-item active " aria-current="page">Form Update Data KRS</li>
    </ol>
  </nav>

	<div class="card">
		<div class="card-header bg-info text-white ">
			<h4><i class="fa fa-edit"></i> Update Data KRS</h4>
		</div>
		<div class="card-body">
			<form method="post" action="<?php echo base_url('admin/krs/update_aksi') ?>">
