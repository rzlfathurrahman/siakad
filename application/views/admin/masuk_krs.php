<div class="container-fluid">
  ...
  <nav aria-label="breadcrumb" >
    ...
    <li><i class="fas fa-university mr-2"></i></li>
      ...
      <li class="breadcrumb-item active" aria-current="page">Masuk Halaman KRS</li>
    </ol>
  </nav>
	...
	<div class="card mb-3">
		<div class="card-header bg-info text-light">
			<h5><i class="fa fa-door-open"></i> Masuk Halaman KRS</h5>
		</div>
		<div class="card-body">
		   <form method="post" action="<?php echo base_url('admin/krs/krs_aksi') ?>" class="">
